...
function load_shift8_cdn_wp_admin_style() {
        // admin always last
        wp_enqueue_style( 'shift8_cdn_css', plugin_dir_url(dirname(__FILE__)) . 'css/shift8_cdn_admin.css', array(), '1.4' );
        wp_enqueue_script( 'shift8_cdn_script', plugin_dir_url(dirname(__FILE__)) . 'js/shift8_cdn_admin.js', array(), '1.4' );
